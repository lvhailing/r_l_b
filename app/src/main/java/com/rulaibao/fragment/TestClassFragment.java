...
import com.rulaibao.adapter.TestClassListAdapter;
...
public class TestClassFragment extends BaseFragment {
    ...
    private TestClassListAdapter adapter;
    private int page = 1;
    ...
    protected void initViews() {
        ...
        adapter=new TestClassListAdapter(context,courseList);
    ...
    public static TestClassFragment newInstance(String newsId) {
        TestClassFragment fragment = new TestClassFragment();
