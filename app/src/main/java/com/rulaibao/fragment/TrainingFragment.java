...
//                    Toast.makeText(context,params.result.toString(),Toast.LENGTH_SHORT).show();
    ...
    public void setView(){
        ...
        setQualityView(bean.getQualityCourseList());


    }

    public void setQualityView(MouldList<ResultClassIndexQualityBean> qualityCourseList){
        tvTrainingBoutiqueFirst.setText(qualityCourseList.get(0).getCourseName());

        ivTrainingBoutiqueFirst.setImageResource(getClassImgIndex(qualityCourseList.get(0).getCourseLogo()));


        tvTrainingBoutiqueSecond.setText(qualityCourseList.get(1).getCourseName());

        ivTrainingBoutiqueSecond.setImageResource(getClassImgIndex(qualityCourseList.get(1).getCourseLogo()));

        tvTrainingBoutiqueThird.setText(qualityCourseList.get(2).getCourseName());

        ivTrainingBoutiqueThird.setImageResource(getClassImgIndex(qualityCourseList.get(2).getCourseLogo()));

        tvTrainingBoutiqueForth.setText(qualityCourseList.get(3).getCourseName());

        ivTrainingBoutiqueForth.setImageResource(getClassImgIndex(qualityCourseList.get(3).getCourseLogo()));
