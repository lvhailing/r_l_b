...
public class DropDownMenu extends LinearLayout {
    ...
    //tab选中颜色
    private int textSelectedColor = 0xff111111;
    //tab未选中颜色
    ...
    private float menuHeighPercent = 0.8f;
     ...
     * @param popupViews
     */
    public void setDropDownMenu(@NonNull String tabText, @NonNull List<View> popupViews) {
        addTab(tabText);
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (SystemInfo.getScreenSize(getContext()).y*menuHeighPercent)));
    ...
    private void addTab(String tabText) {
        ...
        tab.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    ((TextView) tabMenuView.getChildAt(i)).setCompoundDrawablePadding(dpTpPx(10));
                }
            } else {
