...
public class TabMenu extends PopupWindow {
    ...
    public TabMenu(Context context, View.OnClickListener onClickListener, int resID, String text, int fontSize,
        ...
        mLayout.addView(mImageView,new ViewGroup.LayoutParams(new ViewGroup.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)));
