...
public class MyCollectionRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final MouldList<MyCollectionList3B> list;
    Context mContext;
    ...
    public MyCollectionRecycleAdapter(Context context, MouldList<MyCollectionList3B> list) {
        mContext = context;
        this.list = list;
...
//                    mContext.startActivity(intent);
    ...
    public void AddHeaderItem(MouldList<MyCollectionList3B> items) {
        list.addAll(0, items);
        notifyDataSetChanged();
    }

    public void AddFooterItem(MouldList<MyCollectionList3B> items) {
        list.addAll(items);
        notifyDataSetChanged();
    }
